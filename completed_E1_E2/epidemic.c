...
{
	newnode->next = *head; //the actual head pointer
	*head = newnode;
	//no return bc we are manipulating the actual memory not passing copies
}
...
//gcc -std=c11 -Wall -Wextra -Werror epidemic.c -o epidemic
//./epidemic 150 100000 10 100000